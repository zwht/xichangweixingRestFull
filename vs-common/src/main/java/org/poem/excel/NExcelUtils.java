...
public class NExcelUtils {
    ...
    private static final Logger logger = LoggerFactory.getLogger(NExcelUtils.class);
    ...
    private static <T> LinkedHashMap<String, String> getCloumnField(Class<T> tClass) {
        ...
        for (Field field : fields) {
            ...
            if (columnField != null) {
                map.put(field.getName(), columnField.value());
            }
        }
        return map;
    }
     ...
     * @return
     */
    private static List<String> validateCell(int r, int c, String stringCellValue, ColumnField columnField) {
