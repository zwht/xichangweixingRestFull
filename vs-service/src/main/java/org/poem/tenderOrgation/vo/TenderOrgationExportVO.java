package org.poem.tenderOrgation.vo;
...
@Api("投标机构")
public class TenderOrgationExportVO {

    @ApiModelProperty(value = "机构编码")
    @ColumnField(value = "机构编码")
    private String code;

    @ApiModelProperty(value = "机构名字")
    @ColumnField(value = "机构名字")
    private String name;
    ...
    @ColumnField(value = "联系人身份证号", isNumber = true)
    ...
    @ColumnField(value = "评级" , isNumber = true)
